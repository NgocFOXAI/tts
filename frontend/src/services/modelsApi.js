...
class ModelsApiService {
  ...
  async getTTSModels() {
    return this.request('/models/tts');
  }

  // Get text generation models
  async getTextGenerationModels() {
    return this.request('/models/text-generation');
  }

  // Get system prompts for text generation
  async getSystemPrompts() {
    return this.request('/models/system-prompts');
  }

  // Get all models data
  async getAllModels() {
    return this.request('/models/all');
  }

  // Get TTS prompts
  async getTTSPrompts() {
    return this.request('/models/tts/prompts');
  }

  // Save TTS prompt
  async saveTTSPrompt(promptName, promptText) {
    const url = `${this.baseURL}/models/tts/prompts/${promptName}`;
